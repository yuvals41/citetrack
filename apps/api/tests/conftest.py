...
def mock_prisma() -> MagicMock:
    ...
    prisma.workspace = _make_model_mock()
    prisma.run = _make_model_mock()
    prisma.mention = _make_model_mock()
    prisma.metricsnapshot = _make_model_mock()
    prisma.brand = _make_model_mock()
    prisma.competitor = _make_model_mock()
    prisma.prompt = _make_model_mock()
    prisma.recommendation = _make_model_mock()
    prisma.pixelevent = _make_model_mock()
    prisma.workspaceschedule = _make_model_mock()

    prisma.scanjob = _make_model_mock()
    prisma.scanexecution = _make_model_mock()
    prisma.promptexecution = _make_model_mock()
    prisma.observation = _make_model_mock()
    prisma.promptexecutioncitation = _make_model_mock()
