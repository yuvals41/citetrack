...
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@citetrack/ui/table";
...
import { usePixelSnippet, usePixelStats } from "./queries";
        ...
        <CardContent>
          {snippetQuery.isPending ? (
            ...
            <p className="text-sm text-destructive">
              Failed to load snippet: {snippetQuery.error.message}
            </p>
          ) : snippetQuery.data ? (
        ...
        {statsQuery.isPending ? (
          ...
          <>
            ...
            <KPICard>
              ...
              <KPICardValue>
                {formatConversionRate(stats.total_visits, stats.total_conversions)}
              </KPICardValue>
            </KPICard>
          </>
        ) : null}
...
export function PixelPage() {
  const { workspace, isPending } = useCurrentWorkspace();
