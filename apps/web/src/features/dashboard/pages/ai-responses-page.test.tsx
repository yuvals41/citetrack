...
function mockQueryState(
  ...
  responsesQuery: QueryState<AIResponsesList | { degraded: { reason: string; message: string; recoverable: boolean } }>,
) {
...
describe("AIResponsesPage", () => {
  ...
  it("renders empty state when there are no responses", () => {
    ...
    expect(screen.getByText("Responses appear after your first scan completes.")).toBeInTheDocument();
  });
