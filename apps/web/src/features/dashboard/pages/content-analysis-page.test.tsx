...
const { hookState } = vi.hoisted(() => ({
  hookState: {
    extractability: { data: undefined, isPending: false, error: null, mutateAsync: vi.fn() } as MutationState,
    crawler: { data: undefined, isPending: false, error: null, mutateAsync: vi.fn() } as MutationState,
    fanout: { data: undefined, isPending: false, error: null, mutateAsync: vi.fn() } as MutationState,
    entity: { data: undefined, isPending: false, error: null, mutateAsync: vi.fn() } as MutationState,
    shopping: { data: undefined, isPending: false, error: null, mutateAsync: vi.fn() } as MutationState,
  },
}));
...
describe("ContentAnalysisPage", () => {
  beforeEach(() => {
    ...
    hookState.extractability = { data: undefined, isPending: false, error: null, mutateAsync: vi.fn().mockResolvedValue(undefined) };
    hookState.crawler = { data: undefined, isPending: false, error: null, mutateAsync: vi.fn().mockResolvedValue(undefined) };
    hookState.fanout = { data: undefined, isPending: false, error: null, mutateAsync: vi.fn().mockResolvedValue(undefined) };
    hookState.entity = { data: undefined, isPending: false, error: null, mutateAsync: vi.fn().mockResolvedValue(undefined) };
    hookState.shopping = { data: undefined, isPending: false, error: null, mutateAsync: vi.fn().mockResolvedValue(undefined) };
    let index = 0;
