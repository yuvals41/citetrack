              ...
              >
                <div className="flex flex-col gap-0.5 min-w-0">
                  ...
                  {typeof finding.message === "string" && finding.message && (
                    <span className="text-xs text-muted-foreground truncate">{finding.message}</span>
                  )}
                </div>
                <div className="flex items-center gap-3 shrink-0 ml-4">
                  <span className="text-sm tabular-nums text-muted-foreground">{finding.count}</span>
                  <span
