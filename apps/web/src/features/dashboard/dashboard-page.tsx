...
import { useSnapshotActions, useSnapshotFindings } from "#/features/actions/queries";
...
export function DashboardPage() {
  ...
  const overviewData = overview.data && !isDegraded(overview.data) ? overview.data : null;
  ...
  const findingsData = findings.data && !isDegraded(findings.data) ? findings.data : null;
  ...
  const breakdownsData = breakdowns.data && !isDegraded(breakdowns.data) ? breakdowns.data : null;
