...
import { Form, FormControl, FormField, FormItem, FormLabel, FormMessage } from "@citetrack/ui/form";
...
import { useCreateCompetitor, useDeleteCompetitor } from "./mutations";
import { useCompetitors } from "./queries";
...
const LOADING_SKELETON_IDS = [
  "competitor-loading-1",
  "competitor-loading-2",
  "competitor-loading-3",
  "competitor-loading-4",
] as const;
              ...
              <Card className="gap-0 py-0">
                {competitors.map((competitor, index) => (
                  <CompetitorCard
                    ...
                    isRemoving={
                      deleteCompetitor.isPending && deleteCompetitor.variables === competitor.id
                    }
                    onRemove={(item) => {
