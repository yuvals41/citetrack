import type { FindingsSummary, OverviewSnapshot, TrendResponse } from "@citetrack/api-client";
...
describe("FindingsList", () => {
  ...
  it("renders the degraded notice on the dashboard", () => {
    ...
    expect(screen.getByText("fallback: Findings are temporarily unavailable")).toBeInTheDocument();
  });
});
