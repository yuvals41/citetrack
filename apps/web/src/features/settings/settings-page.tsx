      ...
      <>
        ...
        <main className="flex-1 overflow-auto px-6 py-8">
          <div className="mx-auto max-w-3xl">
            <Alert variant="error">Failed to load settings: {settingsQuery.error.message}</Alert>
          </div>
        </main>
      </>
    );
  ...
  return (
    <Card className="p-6">
      ...
      <div className="mt-4 space-y-2">
        ...
        {savedMessage ? <p className="text-xs text-muted-foreground pt-1">{savedMessage}</p> : null}
      </div>
    </Card>
  );
}
